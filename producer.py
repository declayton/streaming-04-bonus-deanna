...
if __name__ == "__main__":  
    ...
    for row in reader:
        ...
        message1 = " ".join(sys.argv[1:]) or f"{FranchiseID}"
        message2 = " ".join(sys.argv[1:]) or f"{FranchiseName}"
        # send the message to the queue
        send_message("localhost","bonus_queue1",message1)
        send_message("localhost","bonus_queue2",message2)
